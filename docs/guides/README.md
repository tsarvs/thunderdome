...
| [`tournament-author-guide.md`](tournament-author-guide.md) | Configuring and persisting a tournament     | Real for round robin (Phase 7), single elimination (Phase 9), and persistence (Phase 11); Swiss/pool-then-elimination not built       |
