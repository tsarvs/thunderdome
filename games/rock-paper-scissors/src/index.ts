...
// name (`rockPaperScissors` here), so every game's entrypoint must also export its
// GameDefinition under this fixed name.
export { rockPaperScissors as game } from './game.js';
