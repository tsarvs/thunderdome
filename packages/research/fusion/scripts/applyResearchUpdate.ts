 ...
 *   nothing is written. This matches `packages/market-data/scripts/fetchAndAppendBars.ts`'s own
...
export type MergeResult =
  | { ok: true; dataset: ResearchDataset; summary: MergeSummary }
...
export type ApplyResult =
  | { ok: true; version: string; summary: MergeSummary }
  | { ok: false; reason: string };
 ...
 * `packages/market-data/scripts/appendBarsFromFile.ts` already uses.
 */
