...
**v1, vs. [`fusion-fundamental-v0`](../fusion-fundamental-v0):**
...
```bash
cd bots/stock-market-4/fusion-fundamental-v1
...
```bash
yarn thunderdome match forward run fusion-live fusion-fundamental-v1 --config '{
...
```bash
yarn thunderdome match forward run fusion-live fusion-fundamental-v1
