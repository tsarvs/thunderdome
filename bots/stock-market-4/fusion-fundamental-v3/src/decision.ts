import type { ConfidenceCalibration, FusionFundamentalConfig, PortfolioPolicy, SecurityConfig, SignalLevel, SignalThresholds, TrendFilterPolicy } from './config.js';
...
import { computeInformationGap, computePriceStabilityConfidence, computeSignal, computeTrailingReturn } from './signal.js';
