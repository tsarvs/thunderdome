...
const correlationSizing = { windowDays: 20, concentrationPenalty: 0.5, minScaleFactor: 0.25 };
const thesisGroupCap = { minSharedExposureIds: 1, maxGroupWeight: 0.375 };
const advancedSignal = { supplierCaptureThresholdShift: 0.08, marketImpliedOptimismConfidencePenalty: 0.5, marketImpliedUpsideConfidenceBoost: 1.2 };
