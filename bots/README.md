...
| [`stock-market-4/fusion-fundamental-v0`](stock-market-4/fusion-fundamental-v0/) | Stock Market 4 | TypeScript | Reads point-in-time research on 5 real fusion-energy supply-chain companies, turns it into a fair-value estimate per company via an explicit Bear/Base/Bull range, and trades the gap against the market price — buy when undervalued, trim when not, hold otherwise. |
| [`stock-market-4/fusion-fundamental-v1`](stock-market-4/fusion-fundamental-v1/) | Stock Market 4 | TypeScript | Adds a `STRONG_SELL` level over v0 that can open a short (gated behind an independent confidence floor on top of the valuation gap) and tunes its hysteresis/rebalance-tolerance parameters off a real backtest sweep. |
| [`stock-market-4/fusion-fundamental-v2`](stock-market-4/fusion-fundamental-v2/) | Stock Market 4 | TypeScript | Expands coverage to 7 companies; executes each round's trades in conviction order (strongest signal first) rather than array order, and carves out an emergency cash reserve plus a floating dry-powder target before spending the rest of the round's budget. |
| [`stock-market-4/fusion-fundamental-v3`](stock-market-4/fusion-fundamental-v3/) | Stock Market 4 | TypeScript | Adds a momentum/trend-confirmation filter on top of v2's valuation signal that vetoes opening or adding to a position when recent price action strongly contradicts the trade (buying into a steep decline, shorting into a steep rally). |
| [`stock-market-4/fusion-fundamental-v4`](stock-market-4/fusion-fundamental-v4/) | Stock Market 4 | TypeScript | Adds inverse-volatility ("risk-parity") position sizing on top of v3 — a calmer security scales its target weight up, a choppier one scales down, so two securities at the same signal level don't automatically get the same dollar risk. |
| [`stock-market-4/fusion-fundamental-v5`](stock-market-4/fusion-fundamental-v5/) | Stock Market 4 | TypeScript | Adds a trailing stop-loss on top of v4 that force-exits a position once price has moved far enough against its own entry price, regardless of what the valuation signal currently says — an unconditional backstop, checked last. |
| [`stock-market-4/fusion-fundamental-v6`](stock-market-4/fusion-fundamental-v6/) | Stock Market 4 | TypeScript | Tracks the full 11-company universe; same valuation/shorting/trend-filter/volatility-sizing/stop-loss stack as v0-v5, consolidated and documented as one coherent risk-management story. |
| [`stock-market-4/fusion-fundamental-v7`](stock-market-4/fusion-fundamental-v7/) | Stock Market 4 | TypeScript | Refines v6's valuation and event-interpretation logic and adds a market-implied-gap read (inferring what the current price already assumes) plus a dedicated position-exposure module. |
| [`stock-market-4/fusion-quant-v0`](stock-market-4/fusion-quant-v0/) | Stock Market 4 | TypeScript | Successor to v6/v7's single-fair-value-to-fixed-bucket shape: runs a quant-desk-style pipeline (independent alpha signals → measured combination → pluggable portfolio construction → a risk stage that can only ever shrink exposure, never override) over the same 11-company universe, built on the shared [`@thunderdome/quant-sdk-js`](../packages/stock-market-4/quant-sdk-js/) package so the pipeline itself isn't fusion-specific. |
